...
class LazyJSONEncoder(simplejson.JSONEncoder):
  """
    ...
    your code about how to handle your type of object here to use when 
    dumping json 
  """
  def default(self,o):
...
class JSONResponse(HttpResponse):
  """ JSON response class """
  def __init__(self,content='',json_opts={},jsonp=None,mimetype="application/json",*args,**kwargs):
    """
